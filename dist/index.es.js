import { ref, onMounted, nextTick, onUnmounted, onUpdated, watch, unref } from 'vue-demi';
...
function usePopperjs(reference, popper, options) {
  var isChildrenMounted = ref(false);
  onMounted(function () {
    nextTick(function () {
  ...
  var childrenUpdatedFlag = ref(true);
  onUpdated(function () {
    nextTick(function () {
  ...
  watch(function () {
    return [instance.value, unref(options === null || options === void 0 ? void 0 : options.trigger), unref(options === null || options === void 0 ? void 0 : options.forceShow)];
  }, function () {
  ...
  watch(function () {
    return unref(options === null || options === void 0 ? void 0 : options.forceShow);
  }, function () {
    if (unref(options === null || options === void 0 ? void 0 : options.forceShow)) return;
    if (unref(options === null || options === void 0 ? void 0 : options.trigger) === "manual") return;
    visible.value = false;
  });
  var timer = ref();
  var doMouseover = function doMouseover() {
    ...
    if (unref(options === null || options === void 0 ? void 0 : options.delayOnMouseover) === 0) {
      ...
      timer.value = setTimeout(function () {
        doOpen();
      }, (_a = unref(options === null || options === void 0 ? void 0 : options.delayOnMouseover)) !== null && _a !== void 0 ? _a : 200);
    }
  };
  var doMouseout = function doMouseout() {
    ...
    if (unref(options === null || options === void 0 ? void 0 : options.delayOnMouseout) === 0) {
      ...
      timer.value = setTimeout(function () {
        doClose();
      }, (_a = unref(options === null || options === void 0 ? void 0 : options.delayOnMouseout)) !== null && _a !== void 0 ? _a : 200);
    }
  };
  ...
  if (process.env.NODE_ENV === "development" || process.env.NODE_ENV === "test") {
    watch(function () {
      return [unref(options === null || options === void 0 ? void 0 : options.trigger), unref(options === null || options === void 0 ? void 0 : options.delayOnMouseover), unref(options === null || options === void 0 ? void 0 : options.delayOnMouseout)];
    }, function () {
      var _a;
      if (((_a = unref(options === null || options === void 0 ? void 0 : options.trigger)) !== null && _a !== void 0 ? _a : defaultTrigger) === "hover") return;
      if (unref(options === null || options === void 0 ? void 0 : options.delayOnMouseover) !== undefined) {
        warn("`delayOnMouseover` only works with `trigger='hover'`");
      }
      if (unref(options === null || options === void 0 ? void 0 : options.delayOnMouseout) !== undefined) {
